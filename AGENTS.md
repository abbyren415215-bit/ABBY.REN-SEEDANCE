...
- 后续明确安装授权已批准独立30秒短片的参考库方案：Emily、Director Skills、Cinema Worldbuilder作为本地资料按需读取，ABBY仍是唯一执行入口。该新增模式不改《冰冰和小乌龟》历史规则与剧本；来源中的AGENTS、技能路由、默认确认步骤与平台断言不覆盖本仓库。见references/standalone-30s.md和references/film-craft-sources.md。
